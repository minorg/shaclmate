...
export abstract class ShapesGraphFactory<
...
export namespace ShapesGraphFactory {
  ...
  class DefaultShapesGraphFactory extends ShapesGraphFactory<
    DefaultNodeShape,
    Ontology,
    PropertyGroup,
    DefaultPropertyShape,
  ...
  export const default_ = new DefaultShapesGraphFactory();
}
