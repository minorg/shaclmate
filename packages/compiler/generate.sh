...
../../apps/cli/dist/cli.js generate ts --feature rdf $PWD/../shacl-ast/src/shacl-ast.shaclmate.ttl $PWD/src/input/input.shaclmate.ttl | sponge src/input/generated.ts
