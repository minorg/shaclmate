...
export function transformShapeToAstObjectType(
  ...
  try {
    ...
    return Eithers.chain2(nodeShape.and, nodeShape.xone).chain(
      ([andShapes, xoneShapes]) => {
        ...
        return Eithers.chain9(
          ...
          nodeShape.tsObjectDeclarationType.isJust()
            ...
            : shapeOntology
                ...
                .map((ontology) =>
                  ontology.chain(
                    (ontology) => ontology.tsObjectDeclarationType,
                  ),
                ),
          ...
          ([
            ...
            const objectType = new ast.ObjectType({
              ...
              tsObjectDeclarationType:
                tsObjectDeclarationType.orDefault("class"),
            });
            ...
            return (() => {
              ...
              this.cachedAstTypesByShapeIdentifier.delete(
                nodeShape.$identifier,
              );
            });
          },
