    ...
    parameters: [
      {
        ...
        name: "parameters",
        type: '{ ignoreRdfType?: boolean; lanugageIn?: readonly string[]; subject?: sparqljs.Triple["subject"]; variablePrefix?: string; } & Omit<sparqljs.ConstructQuery, "prefixes" | "queryType" | "type"> & sparqljs.GeneratorOptions',
      },
    ],
    returnType: "string",
    statements: [
