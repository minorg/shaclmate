...
export abstract class Type {
  ...
  /**
   * An expression that converts a purify.Either<Error, rdfjsResource.Resource.Values<rdfjsResource.Resource.Value>> to a purify.Either<Error, rdfjsResource.Resource.Values<this type>>.
   *
