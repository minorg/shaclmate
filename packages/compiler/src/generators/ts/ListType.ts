      ...
      [
        ...
        valueLists.chainMap(
          valueList => ${this.itemType.fromRdfExpression({
            variables: {
              ...variables,
              resourceValues: code`${imports.Right}(${imports.Resource}.Values.fromArray({ focusResource: ${variables.resource}, propertyPath: ${variables.predicate}, values: valueList.toArray() }))`,
            },
          })}
