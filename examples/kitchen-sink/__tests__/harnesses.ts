...
export const harnesses = {
  ...
  numericPropertiesClass: new ClassHarness(
    new kitchenSink.NumericPropertiesClass({
      ...
      integerNumericProperty: 1,
      longNumericProperty: -1,
      negativeIntegerNumericProperty: -1,
      nonNegativeIntegerNumericProperty: 0,
      nonPositiveIntegerNumericProperty: 0,
      positiveIntegerNumericProperty: 1,
      shortNumericProperty: 1,
      unsignedByteNumericProperty: 1,
      unsignedIntNumericProperty: 1,
      unsignedLongNumericProperty: 1,
