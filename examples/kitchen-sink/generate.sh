...
time ../../apps/cli/dist/cli.js generate ts --feature equals --feature hash --feature json --feature rdf --feature sparql src/kitchen-sink.shaclmate.ttl | sponge src/generated.ts
