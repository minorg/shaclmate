...
function $convertToArray<ItemSourceT, ItemTargetT, Readonly extends boolean>(
  ...
  return (value: readonly ItemSourceT[] | undefined): Either<Error, EitherR> =>
    (typeof value === "undefined" ? Either.of([]) : Either.sequence(value.map(convertToItem))) as Either<
      Error,
      EitherR
    >;
}
...
export namespace NestedNodeShape {
  export function create(
    parameters: {
      readonly $identifier?: (() => NestedNodeShape.Identifier) | BlankNode | NamedNode | string;
      readonly requiredStringProperty: string;
    },
    ...
    return ($sequenceRecord({
      ...
      $monkeyPatchObject({ ...properties, $type: "NestedNodeShape" as const }, { toJson, $toString })
    );
  }
    ...
    export function uiSchema(parameters?: { scopePrefix?: string }): any {
      ...
      return {
        "elements": [{ label: "Identifier", scope: `${scopePrefix}/properties/@id`, type: "Control" }, {
          rule: {
            condition: { schema: { const: "NestedNodeShape" as const }, scope: `${scopePrefix}/properties/@type` },
            effect: "HIDE",
          },
  ...
  export function fromJson($json: NestedNodeShape.Json): Either<Error, NestedNodeShape> {
    return ($sequenceRecord({
  ...
  export function isNestedNodeShape(object: $Object): object is NestedNodeShape {
    switch (object.$type) {
  ...
  export function toJson(_nestedNodeShape: NestedNodeShape): NestedNodeShape.Json {
    return JSON.parse(
      JSON.stringify(
        {
          "@id": _nestedNodeShape.$identifier().termType === "BlankNode"
  ...
  export const _toRdfResource: $_ToRdfResourceFunction<NestedNodeShape.Identifier, NestedNodeShape> = (parameters) => {
    parameters.resource.add(NestedNodeShape.schema.properties.requiredStringProperty.path, [
  ...
  export function _propertiesToStrings(_nestedNodeShape: NestedNodeShape): Record<string, string> {
    return $compactRecord({ "$identifier": _nestedNodeShape.$identifier().toString() });
  }
...
export namespace FormNodeShape {
  export function create(
    parameters: {
      readonly $identifier?: (() => FormNodeShape.Identifier) | BlankNode | NamedNode | string;
      readonly emptyStringSetProperty?: readonly (string)[];
      readonly nestedObjectProperty: NestedNodeShape;
      readonly nonEmptyStringSetProperty: readonly (string)[];
    ...
    return ($sequenceRecord({
      $identifier: $convertToIdentifierProperty(parameters.$identifier),
      emptyStringSetProperty: $convertToArray($identityConversionFunction, true)(parameters.emptyStringSetProperty)
        .chain((value) =>
      ...
      nonEmptyStringSetProperty: $convertToArray($identityConversionFunction, true)(
      ...
      $monkeyPatchObject({ ...properties, $type: "FormNodeShape" as const }, { toJson, $toString })
    );
  }
  ...
  export namespace Json {
    ...
    export function schema() {
      return z.object({
        ...
        "nestedObjectProperty": NestedNodeShape.Json.schema().meta({ "title": "Nested object" }),
    ...
    export function uiSchema(parameters?: { scopePrefix?: string }): any {
      ...
      return {
        "elements": [
          ...
          {
            rule: {
              condition: { schema: { const: "FormNodeShape" as const }, scope: `${scopePrefix}/properties/@type` },
              effect: "HIDE",
            },
            scope: `${scopePrefix}/properties/@type`,
            type: "Control",
          ...
          NestedNodeShape.Json.uiSchema({ scopePrefix: `${scopePrefix}/properties/nestedObjectProperty` }),
          {
  ...
  export function fromJson($json: FormNodeShape.Json): Either<Error, FormNodeShape> {
    return ($sequenceRecord({
      $identifier: Either.of<Error, (BlankNode | NamedNode)>(
        $json["@id"].startsWith("_:")
          ? dataFactory.blankNode($json["@id"].substring(2))
      ...
      nestedObjectProperty: NestedNodeShape.fromJson($json["nestedObjectProperty"]),
  ...
  export function toJson(_formNodeShape: FormNodeShape): FormNodeShape.Json {
    return JSON.parse(JSON.stringify(
      {
        "@id": _formNodeShape.$identifier().termType === "BlankNode"
          ? `_:${_formNodeShape.$identifier().value}`
          : _formNodeShape.$identifier().value,
        "@type": _formNodeShape.$type,
        emptyStringSetProperty: _formNodeShape.emptyStringSetProperty.map((item) => item),
        nestedObjectProperty: NestedNodeShape.toJson(_formNodeShape.nestedObjectProperty),
        nonEmptyStringSetProperty: _formNodeShape.nonEmptyStringSetProperty.map((item) => item),
        optionalStringProperty: _formNodeShape.optionalStringProperty.map((item) => item).extract(),
  ...
  export const _toRdfResource: $_ToRdfResourceFunction<FormNodeShape.Identifier, FormNodeShape> = (parameters) => {
    ...
    parameters.resource.add(FormNodeShape.schema.properties.nestedObjectProperty.path, [
    ...
    parameters.resource.add(FormNodeShape.schema.properties.requiredIntProperty.path, [
      $literalFactory.number(parameters.object.requiredIntProperty, $RdfVocabularies.xsd.int),
    ], parameters.graph);
    parameters.resource.add(FormNodeShape.schema.properties.requiredStringProperty.path, [
      $literalFactory.string(parameters.object.requiredStringProperty),
    ], parameters.graph);
    return parameters.resource;
  };
  ...
  export function _propertiesToStrings(_formNodeShape: FormNodeShape): Record<string, string> {
    return $compactRecord({ "$identifier": _formNodeShape.$identifier().toString() });
  }
...
export namespace $Object {
  ...
  export const fromJson = (value: $Object.Json): Either<Error, $Object> => {
    if ((value["@type"] === "FormNodeShape")) {
      return FormNodeShape.fromJson(value as FormNodeShape.Json).map((value) => value);
    }
    if ((value["@type"] === "NestedNodeShape")) {
      return NestedNodeShape.fromJson(value as NestedNodeShape.Json).map((value) => value);
    }
  ...
  export namespace Json {
    export const schema = () =>
      z.discriminatedUnion("$type", [FormNodeShape.Json.schema(), NestedNodeShape.Json.schema()]).readonly().meta({});
  ...
  export const toRdfResourceValues = ((value, _options): (BlankNode | NamedNode)[] => {
    if (FormNodeShape.isFormNodeShape(value)) {
      return [
        FormNodeShape.toRdfResource(value, { graph: _options.graph, resourceSet: _options.resourceSet }).identifier,
      ];
    }
    if (NestedNodeShape.isNestedNodeShape(value)) {
      return [
        NestedNodeShape.toRdfResource(value, { graph: _options.graph, resourceSet: _options.resourceSet }).identifier,
      ];
    }
